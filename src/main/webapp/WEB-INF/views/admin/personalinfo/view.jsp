...
<div class="nv_contents_wrap">
    <form method="post">
        <div class="nv_contents">
            <div class="nv_contents_main_header"><h4>개인정보처리방침</h4></div>
            ...
            <table class="nv_table nv_write_table" cellpadding="0" cellspacing="0">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><c:out value ="${personalinfo.contents}" escapeXml="false"/></td>
                    </tr>
                    <tr>
                        <td class="nv_bold textcenter">첨부파일</td>
                        <td>
                            <c:forEach items="${personalinfo.files }" var="file">
                                <p>
